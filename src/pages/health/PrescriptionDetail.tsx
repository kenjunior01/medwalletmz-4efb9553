...
import { ArrowLeft, FileText, Pill, Zap, ShieldCheck, Download, CheckCircle2, Share2 } from "@/components/icons/lucide-compat";
        ...
        {items.map((it, idx) => (
          <Card key={it.id} className="p-4">
            <div className="flex items-start gap-3">
              <div className="h-11 w-11 rounded-lg bg-pharmacy/10 flex items-center justify-center flex-shrink-0">
