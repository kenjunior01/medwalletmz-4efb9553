  ...
  return (
    <div className="p-4 flex flex-col gap-4 animate-fade-in">
      <div className="bento-card p-5 flex items-center gap-4">
        ...
        <div className="flex-1"><h1 className="text-xl font-black">{company.name}</h1><p className="text-xs text-muted-foreground">{company.city} · {company.is_verified ? "Verificada" : "Aguarda verificação"}</p></div>
      </div>
