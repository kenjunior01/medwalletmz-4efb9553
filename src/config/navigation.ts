...
export const sidebarByRole: Record<RoleKey, NavItem[]> = {
  ...
  country_manager: [
    { path: "/admin/country-dashboard", icon: LayoutDashboard, label: "nav.dashboard", group: "nav_group.country" },
    { path: "/admin/curation", icon: Shield, label: "nav.approvals", group: "nav_group.country" },
    { path: "/admin/users", icon: Users, label: "nav.users", group: "nav_group.country" },
    { path: "/admin/institutions", icon: Building2, label: "nav.institutions", group: "nav_group.country" },
    { path: "/admin/mpesa-confirmations", icon: Wallet, label: "nav.mobile_payments", group: "nav_group.country" },
    { path: "/admin/transactions", icon: Wallet, label: "nav.financial", group: "nav_group.country" },
    { path: "/admin/country-settings", icon: Settings, label: "nav.settings", group: "nav_group.country" },
    { path: "/admin/campaign-links", icon: Share2, label: "nav.campaigns", group: "nav_group.country" },
    { path: "/admin/subscription-plans", icon: Shield, label: "nav.subscription_plans", group: "nav_group.country" },
    { path: "/admin/assign-provincial-manager", icon: UserPlus, label: "nav.provincial_managers", group: "nav_group.mozambique" },
    { path: "/admin/provincial-permissions", icon: ShieldCheck, label: "nav.provincial_permissions", group: "nav_group.mozambique" },
    { path: "/profile", icon: User, label: "nav.profile", group: "nav_group.account" },
  ],
  provincial_manager: [
