import {
  ...
  UserPlus, ShieldCheck, Share2, Radio, Route, Navigation, Palette, IdCard, MapPin,
...
export const bottomNavByRole: Record<RoleKey, NavItem[]> = {
  ...
  regional_ceo: [
    { path: "/regional-ceo", icon: LayoutDashboard, label: "nav.dashboard" },
    { path: "/regional", icon: MapPin, label: "nav.provincial_ops" },
    { path: "/regional-metrics", icon: BarChart3, label: "nav.analytics" },
    { path: "/regional-ranking", icon: TrendingUp, label: "nav.ranking" },
    { path: "/profile", icon: User, label: "nav.profile" },
  ],
  country_manager: [
...
export const sidebarByRole: Record<RoleKey, NavItem[]> = {
  ...
  provincial_manager: [
    ...
    { path: "/regional/earnings", icon: Wallet, label: "nav.earnings", group: "nav_group.finance" },
    { path: "/regional/content", icon: FileText, label: "nav.provincial_content", group: "nav_group.operations" },
    { path: "/regional/settings", icon: Settings, label: "nav.settings", group: "nav_group.operations" },
    { path: "/profile", icon: User, label: "nav.profile", group: "nav_group.account" },
  ],
  regional_manager: [
    { path: "/regional", icon: LayoutDashboard, label: "nav.dashboard", group: "nav_group.panel" },
  ...
  regional_ceo: [
    { path: "/regional-ceo", icon: LayoutDashboard, label: "nav.dashboard", group: "nav_group.panel" },
    { path: "/regional-metrics", icon: BarChart3, label: "nav.analytics", group: "nav_group.panel" },
    { path: "/regional", icon: MapPin, label: "nav.provincial_ops", group: "nav_group.operations" },
    { path: "/regional/team", icon: Stethoscope, label: "nav.health_professionals", group: "nav_group.people" },
    { path: "/regional/riders", icon: Truck, label: "nav.riders", group: "nav_group.people" },
    { path: "/regional/facilities", icon: Building2, label: "nav.institutions", group: "nav_group.operations" },
    { path: "/regional/earnings", icon: Wallet, label: "nav.earnings", group: "nav_group.finance" },
    { path: "/regional-content", icon: FileText, label: "nav.provincial_content", group: "nav_group.operations" },
    { path: "/regional-ranking", icon: TrendingUp, label: "nav.ranking", group: "nav_group.operations" },
    { path: "/profile", icon: User, label: "nav.profile", group: "nav_group.account" },
  ],
  insurance: [
