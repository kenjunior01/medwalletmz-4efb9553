...
export const sidebarByRole: Record<RoleKey, NavItem[]> = {
  ...
  country_manager: [
    ...
    { path: "/admin/subscription-plans", icon: Shield, label: "Planos de Subscrição", group: "País" },
  ...
  provincial_manager: [
    ...
    { path: "/admin/subscription-plans", icon: Shield, label: "Planos de Subscrição", group: "Operações" },
